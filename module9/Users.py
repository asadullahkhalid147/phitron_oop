...
class Rider(User):
    ...
    def display_profile(self):
        print(f'Rider:with {self.name} and email: {self.email}')
...
sakib = Rider('sakib khan','sakib@khan',1254,'mohakhali',1200)
niye_jao.add_rider(sakib)
kala_pakhi = Driver('kala pakhi','kala@shada.com',5648,'gulsahan1')
