class Student:
    ...
    # the use  of repr to tell a perticular user how the object is created
...
class School:
    ...
    def enroll(self,name,fee):
        if fee<6500:
            ...
            return f'{name} is enrolled with {id}, extra money {fee-6500}'
...
phitron.enroll('khalid',7000)
phitron.enroll('pranto',90000)
